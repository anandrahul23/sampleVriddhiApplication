...
@RestController
@RequestMapping("/api/sample-vriddhi-application-kafka")
public class SampleVriddhiApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SampleVriddhiApplicationKafkaResource.class);
    ...
    public SampleVriddhiApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
